...
public class ButtonHoverOut implements EventHandler<MouseEvent> {
    ...
    public void handle(MouseEvent e) {
        ...
        Demo.buttonColors = "-fx-border-insets: 5px; -fx-background-insets: 5px;  -fx-background-color: #b3b3b3; -fx-text-fill: #000; -fx-border-width: 3; -fx-border-color: #" + Demo.themeColor;
